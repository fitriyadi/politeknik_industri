							...
							<div class="row">
								<div class="col-md-12">
									<div class="auth-form-wrapper px-4 py-5">
										<a href="#" class="noble-ui-logo d-block mb-2"><?= judullogin ?></a>
										...
										<form class="forms-sample" action="logincek.php" method="post">
											...
											<div class="row">
												<div class="mt-3 md-6 ml-3">
													<input type="submit" class="btn btn-primary mr-2 mb-2 mb-md-0 text-white" name="" value="Login">
												</div>
												<div class="mt-3 md-6 ml-3">
													<a class="btn btn-secondary mr-2 mb-2 mb-md-0 text-white" href="user">Halaman User</a>
												</div>
											</div>
										</form>
									</div>
