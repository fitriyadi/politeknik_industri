...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{batal}}">Data Pengajuan</a></li>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Informasi Detail Pengajuan</h6>


                <form class="forms-sample" action="?hal=pengajuan/proses" method="POST">
                    ...
                    <dl class="row">
                        ...
                        <label for="input" class="col-sm-3 col-form-label mt-4">Perbarui Status</label>
                        <div class="col-sm-4 mt-4">
                            <select class="form-control" name="status" required="">
                                <option value="Diterima" <?= isselect(@$statuspengajuan, "Diterima") ?>>Diterima</option>
                                <option value="Ditolak" <?= isselect(@$statuspengajuan, "Ditolak") ?>>Ditolak</option>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-9 mt-2">
                            <textarea class="form-control" name="komentar" placeholder="Inputkan Komentar" rows="3" required><?= @$komentar ?></textarea>
